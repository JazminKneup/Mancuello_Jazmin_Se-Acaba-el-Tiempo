// Función que calcula el número de segundos transcurridos desde el inicio del día
function getSecondsSinceStartOfDay() {
  var now = new Date(); // Obtiene la fecha y hora actual
  return now.getSeconds() + 
    now.getMinutes() * 60 + 
    now.getHours() * 3600; // Calcula los segundos totales desde la medianoche
}

// Función que actualiza la posición de las manecillas del reloj
function updateClock() {
  ...
  var hourDeg = (hours / 12) * 360 + 90; // Ángulo para la manecilla de la hora
  var minuteDeg = (minutes / 60) * 360 + 90; // Ángulo para la manecilla de los minutos
  var secondDeg = (seconds / 60) * 360 + 90; // Ángulo para la manecilla de los segundos
...
updateClock(); // Inicializa la posición del reloj al cargar la página
